...
const configData = {
  page: {
    pageTitle: "Ricardo Realés | UI/UX Product Designer",
    pageDescription:
      "I'm a UI/UX Product Designer with a passion for creating beautiful and functional products.",
    pageKeywords:
      "UI/UX Product Designer, UI/UX Designer, Product Designer, UI/UX, Designer, Product, Designer, UI, UX, Product, Designer, UI, UX, Product, Designer",
  },
  contact: {
