  ...
  return (
    <section className="w-min flex flex-col max-md:gap-4 items-center md:items-start">
      <h1 className=" flex flex-col items-center md:items-start  ">
        <span className="text-3xl  xl:text-5xl italic  text-nowrap mb-2 xl:mb-8">Hey. I&apos;m Ricardo, </span> 
      ...
      <p className=" text-center md:text-left tracking-wider text-xl md:text-lg xl:text-2xl text-wrap  mb-8 xl:mb-8">
